...
| offset   | The offset of the watermark from the selected position in pixels. For non-repeating watermarks, left/top anchors offset from left/top, right/bottom anchors offset from right/bottom, and middle/center anchors adjust from the centered position.                            | [number, number]                                                                                                                                                                             | [gap[0]/2, gap[1]/2]                                                                           |
| position | The position of a non-repeating watermark. This option is ignored when `repeat` is `true`.                                                                                                                                                                                    | 'top-left' \| 'top-middle' \| 'top-right' \| 'middle-left' \| 'center' \| 'middle-right' \| 'bottom-left' \| 'bottom-middle' \| 'bottom-right'                                               | 'top-left'                                                                                     |
